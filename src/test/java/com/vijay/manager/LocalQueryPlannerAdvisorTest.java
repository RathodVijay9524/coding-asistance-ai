...
class LocalQueryPlannerAdvisorTest {

    private LocalQueryPlannerAdvisor advisor;

    @BeforeEach
    void setUp() {
        advisor = new LocalQueryPlannerAdvisor();
    }

    @Test
    @DisplayName("adviseCall should analyze locally and delegate to chain")
    void adviseCall_analyzesAndDelegates() {
        ...
        when(userMessage.getText()).thenReturn("Explain how the SmartQualityAdvisor works in this architecture.");
